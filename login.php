...
<head>
    ...
    <title>Login Administrator | Sistem Informasi Pengolah Data Sertifikasi</title>
            ...
            <div class="content-error">
                ...
                <div class="hpanel">
                    <div class="panel-body">
                        ...
                        <center>
                            <h3>SISTEM INFORMASI <br>PENGOLAH DATA SERTIFIKASI</h3>    
                        </center>
                        <br>
                        <br>
                ...
                <p class="text-muted">Copyright © <?php echo date('Y') ?>. All rights reserved. Sistem Informasi Pengolah Data Sertifikasi</p>
            </div>
            </div>
